...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
		...
		self.opacity = 0.8f;
		self.color = nil;
        self.labelFont =  [UIFont systemFontOfSize:kLabelFontSize];//[UIFont boldSystemFontOfSize:kLabelFontSize];
		self.labelColor = [UIColor whiteColor];
        self.detailsLabelFont = [UIFont systemFontOfSize:kDetailsLabelFontSize];//[UIFont boldSystemFontOfSize:kDetailsLabelFontSize];
